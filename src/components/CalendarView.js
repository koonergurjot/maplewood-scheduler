...
export default function CalendarView({ vacancies, onCreateVacancy }) {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "calendar-mini-toolbar", role: "toolbar", children: [_jsxs("div", { className: "counts", "aria-live": "polite", children: [_jsxs("div", { className: "count", children: [_jsx("span", { className: "badge badge-open", children: openToday }), " Open today"] }), _jsxs("div", { className: "count", children: [_jsx("span", { className: "badge badge-awarded", children: awardedToday }), " Awarded today"] }), _jsxs("div", { className: "count", children: [_jsx("span", { className: "badge badge-filled", children: filledToday }), " Filled today"] })] }), _jsxs("div", { className: "actions", children: [_jsx("button", { className: "calendar-btn", onClick: () => { setY(today.getFullYear()); setM(today.getMonth()); }, "aria-label": "Jump to today", children: "Jump to Today" }), _jsx("button", { className: "calendar-btn", onClick: onCreateVacancy, "aria-label": "Create new vacancy", children: "New Vacancy" }), _jsx("button", { className: "calendar-btn", onClick: () => setShowHeatmap((h) => !h), "aria-pressed": showHeatmap, "aria-label": "Toggle heatmap", children: "Toggle Heatmap" }), _jsx("button", { className: "calendar-btn", onClick: () => setShowFilled((f) => !f), "aria-pressed": showFilled, "aria-label": "Show awarded and filled shifts", children: "Show Awarded/Filled" })] })] }), _jsxs("section", { className: "calendar", "aria-label": "Calendar", children: [_jsxs("div", { className: "calendar-toolbar", children: [_jsxs("div", { className: "controls", children: [_jsx("button", { className: "calendar-btn", onClick: () => prevMonth(setY, setM, y, m), "aria-label": "Previous month", children: "\u25C0" }), _jsx("button", { className: "calendar-btn", onClick: () => { setY(today.getFullYear()); setM(today.getMonth()); }, "aria-label": "Jump to today", children: "Today" }), _jsx("button", { className: "calendar-btn", onClick: () => nextMonth(setY, setM, y, m), "aria-label": "Next month", children: "\u25B6" })] }), _jsx("div", { className: "month-label", children: monthLabel(y, m) }), _jsx("div", { style: { width: 90 } })] }), _jsx("div", { className: "calendar-weekdays", children: Array.from({ length: 7 }).map((_, i) => (_jsx("div", { children: weekdayShort.format(new Date(2025, 0, i + 5)) /* stable labels Sun..Sat */ }, i))) }), _jsx("div", { className: "calendar-grid" + (showHeatmap ? " heatmap" : ""), children: days.map((d) => {
                            ...
                            const { open, awarded, filled, visible } = React.useMemo(() => allEvents.reduce((acc, e) => {
                                ...
                                if (status === "Open") {
                                    ...
                                    acc.filled++;
                                return acc;
                            }, { open: 0, awarded: 0, filled: 0, visible: [] }), [allEvents]);
                            const events = showFilled ? allEvents : visible;
                            return (_jsxs("div", { className: "day-cell" + (d.inMonth ? "" : " outside"), "aria-label": iso, style: { ["--event-count"]: events.length }, children: [_jsxs("div", { className: "day-head", children: [_jsx("div", { children: d.date.getDate() }), _jsxs("div", { style: { display: "flex", gap: 6 }, children: [open ? _jsx("span", { className: "badge badge-open", title: "Open", children: open }) : null, awarded ? _jsx("span", { className: "badge badge-awarded", title: "Awarded", children: awarded }) : null, filled ? _jsx("span", { className: "badge badge-filled", title: "Filled", children: filled }) : null] })] }), _jsxs("div", { className: "events", children: [events.slice(0, 4).map((e, idx) => {
                                                const status = e.status || "Open";
