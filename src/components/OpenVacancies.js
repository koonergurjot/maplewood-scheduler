...
export default function OpenVacancies({ vacancies, stageDelete, undoDelete, staged, readOnly = false, }) {
    ...
    return (_jsxs("div", { children: [!readOnly && selected.length > 0 && (_jsxs("div", { style: {
                    display: "flex",
                    ...
                    padding: 8,
                    borderRadius: 8,
                }, children: [_jsxs("span", { children: [selected.length, " selected"] }), _jsx("button", { className: "btn btn-sm danger", "data-testid": "vacancy-delete-selected", "aria-label": "Delete selected vacancies", tabIndex: 0, onClick: () => confirmDelete(selected), title: "Delete selected vacancies", children: _jsxs("span", { style: { display: "inline-flex", alignItems: "center", gap: 4 }, children: [TrashIcon ? (_jsx(TrashIcon, { style: { width: 16, height: 16 }, "aria-hidden": "true" })) : ("Delete"), _jsx("span", { children: "Delete selected" })] }) })] })), _jsxs("table", { className: "responsive-table", children: [_jsx("thead", { children: _jsxs("tr", { children: [_jsx("th", { children: _jsx("input", { type: "checkbox", checked: allChecked, onChange: (e) => toggleAll(e.target.checked), "aria-label": "Select all vacancies" }) }), _jsx("th", { children: "Role" }), _jsx("th", { children: "Date" }), _jsx("th", { children: "Time" }), _jsx("th", { style: { textAlign: "right", minWidth: 60 }, children: "Actions" })] }) }), _jsxs("tbody", { children: [openVacancies.map((v) => (_jsxs("tr", { children: [_jsx("td", { children: _jsx("input", { type: "checkbox", checked: selected.includes(v.id), onChange: () => toggleSelect(v.id), "aria-label": `Select vacancy ${v.id}` }) }), _jsx("td", { children: v.classification }), _jsx("td", { children: _jsxs("div", { style: {
                                                display: "flex",
                                                alignItems: "center",
                                                gap: 4,
                                                flexWrap: "wrap",
                                            }, children: [_jsx("span", { children: v.startDate && v.endDate && v.startDate !== v.endDate
                                                        ? `${v.startDate}–${v.endDate}`
                                                        : v.shiftDate }), _jsx(CoverageChip, { startDate: v.startDate, endDate: v.endDate, coverageDates: v.coverageDates })] }) }), _jsxs("td", { children: [v.shiftStart, "\u2013", v.shiftEnd] }), _jsx("td", { style: { textAlign: "right" }, children: !readOnly && (_jsx("button", { className: "btn btn-sm", title: "Delete vacancy", "aria-label": "Delete vacancy", "data-testid": `vacancy-delete-${v.id}`, tabIndex: 0, onClick: () => confirmDelete([v.id]), children: TrashIcon ? (_jsxs(_Fragment, { children: [_jsx(TrashIcon, { style: { width: 16, height: 16 }, "aria-hidden": "true" }), _jsx("span", { className: "sr-only", children: "Delete vacancy" })] })) : ("Delete") })) })] }, v.id))), openVacancies.length === 0 && (_jsx("tr", { children: _jsx("td", { colSpan: 5, style: { textAlign: "center" }, children: "No vacancies" }) }))] })] }), _jsx(ConfirmDialog, { open: !!pending, title: "Delete vacancy?", body: pending && pending.length === 1
