...
import type { Bid, Vacancy, Vacation, Employee, Status, Classification } from "../App";
import EmployeeCombo from "./EmployeeCombo";
import { isoDate } from "../utils/date";
import { displayVacancyLabel } from "../utils/vacancy";

export default function BidsPage({bids,setBids,vacancies,vacations,employees,employeesById}:{bids:Bid[];setBids:(u:any)=>void;vacancies:Vacancy[];vacations:Vacation[];employees:Employee[];employeesById:Record<string,Employee>}){
