...
import type { Bid, Vacancy, Vacation, Employee, Status, Classification } from '../types';
import { displayVacancyLabel, isoDate } from '../utils';
...
export default function BidsPage({ bids, setBids, vacancies, vacations, employees, employeesById }: Props) {
