...
function InlineEmployeePicker({ employees, value, onChange }) {
    ...
    return (_jsxs("div", { className: "dropdown", children: [_jsx("input", { placeholder: "Type name\u2026", value: q, onChange: (e) => setQ(e.target.value), onFocus: () => { } }), _jsxs("div", { className: "menu", style: { maxHeight: 240, overflow: "auto" }, children: [list.map((e) => (_jsxs("button", { type: "button", className: "item", onClick: () => { onChange(e.id); setQ(""); }, children: [e.firstName, " ", e.lastName] }, e.id))), !list.length && _jsx("div", { className: "item", style: { opacity: .7 }, children: "No matches" })] })] }));
}
