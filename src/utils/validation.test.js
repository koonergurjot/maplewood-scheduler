...
import { validateDateRange, validateRequired, validateTime, validateTimeRange, validateClassification, validateSelection } from "./validation";
...
describe("validateSelection", () => {
    ...
    it("should reject null/undefined selection", () => {
        const result = validateSelection(undefined, "coverage day");
        expect(result.isValid).toBe(false);
        expect(result.error).toBe("At least one coverage day must be selected");
    });
});
